...
wS = 2*pi / (24*60*60);
vTang = wS * d;
m=[5.9736E+24,7.349E+22, mS];
%
% cada móvil en una columna
%
% r0=[[0;0;0],[6378000.0+108000.0;0;0]];
r0=[[0;0;0],[3.832557907001450e+08;0;0], [d;0;0]];
v0=[[0;0;0],[0;1.019927755507821e+03;0], [0;vTang;0]];
r=[[r0;v0]];
...
plot3(pos(:,1),pos(:,2),pos(:,3),'r*',pos(:,4),pos(:,5),pos(:,6),'b.',pos(:,7),pos(:,8),pos(:,9),'y-')
